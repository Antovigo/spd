...
`jax_single_pool.llama_simple_mlp.load_target_from_pretrain_cache` reads a cache dir
...
from jax_single_pool.pretrain.config import PretrainConfig
from jax_single_pool.pretrain.models import PretrainModel
...
def torch_model_config_dict(cfg: PretrainConfig) -> dict[str, object]:
    """The `model_config.yaml` shape `jax_single_pool.llama_simple_mlp` parses — the torch
