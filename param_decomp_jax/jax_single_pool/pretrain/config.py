"""The single self-contained pretrain run config (`jsp-pretrain` reads it directly).
...
the offline pre-tokenized parquet artifact served by `jax_single_pool.data.ShardServer` —
