...
class NontargetCIMeanPerComponent(Metric[NontargetCIMeanPerComponentConfig]):
    """`CIMeanPerComponent` sibling fed by the nontarget eval loop (targeted runs)."""
    ...
    def compute(self) -> MetricResult:
        ...
        return {
            "nontarget_ci_mean_per_component": img_linear,
            "nontarget_ci_mean_per_component_log": img_log,
        }
