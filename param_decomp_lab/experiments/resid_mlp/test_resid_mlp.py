...
identity, MSE recon, residual accumulation), the reused MLP CI fn, the full four-term
step trains, and the ground-truth target-CI eval — including an end-to-end pretrain →
