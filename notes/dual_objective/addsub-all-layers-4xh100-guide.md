...
Cold compiles are silent: the log shows `targeted run addsub-all-layers-trial-... | 4 GPU`
...
kill): attach the same network volume to a fresh 4x H100 SXM pod, redo `source env.sh`
...
1. Pull `ab_grids/`, `metrics.jsonl`, `launch_config.yaml`, `logs/`, `ladder-4xh100/summary.md`,
