...
def main() -> None:
    ...
    rho_note = (
        ...
        if a.rho == 1.0
            ...
            f"#   hidden recon coefficients / rho={a.rho:g} — the measured per_position/batch\n"
            f"#     scale ratio, so the balanced recipe keeps the L18 recon/sparsity exchange\n"
            f"#     rate rather than an unmeasured multiple of it.\n"
        )
    )
    banner = (
