...
The components the integer objective drops (476 of them) are analysed in
[`report_comp_classification.md`](report_comp_classification.md#what-the-integer-objective-drops-borderline-components-not-a-non-integer-mechanism):
they are borderline components, not a non-integer mechanism.
