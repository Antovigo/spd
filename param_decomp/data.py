"""Deterministic batch schedule over pre-tokenized parquet shards.
...
a many-rank HF-streaming stampede at launch is a failure mode the torch side already
paid for. Reads are plain pyarrow.
