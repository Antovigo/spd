...
def test_qk_norm_is_load_bearing():
    ...
    # `stacked` is the DECOMPOSED SPAN (the frozen tail above it is its own field), so its
    # leading axis counts the span's blocks and layer 4 sits at 4 - split_layer.
