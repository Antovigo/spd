...
batched across same-shape leaves and sharded on the stack axis (`impl: stacked`).
...
reassociation — same tolerance class as device-count invariance.
"""
...
def _muon_mask_from_validated_dim_numbers(
    ...
    the cross-impl promise, so it dies here at optimizer build instead."""
