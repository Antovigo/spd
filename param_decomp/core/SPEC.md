...
types stay closed (`NontargetReconLossMetricConfig`: the stochastic/constant-source
recon types plus `UnmaskedNoDeltaReconLoss` only); the OUTPUT pass's union adds the two
