...
| `run.py` | the training entrypoint (`python -m param_decomp.run <config.yaml>`): data, faith warmup, loop, metrics jsonl/wandb, orbax checkpoints, SIGTERM-save + requeue-resume |
