...
def test_nonmean_metric_is_jensen_divergent():
    """A metric that is a nonlinear fn of a GLOBAL accumulated sum (the sum-inside-nonlinearity caveat,
...
def test_production_fast_set_classification(metric_key: str, kind: str):
    ...
    under fixed (B,T). This list is deliberately exhaustive — adding a metric here
