...
masked forward, shapes, site seams) and the full training step — for mixed attention + MLP
...
def test_clean_path_and_masked_identity():
    ...
    # A masked forward with NO live sites is the frozen path — bit-identical.
...
def test_step_trains_and_has_vpd_signature():
    ...
    # P annealed below its 2.0 start by step 4 of 100.
