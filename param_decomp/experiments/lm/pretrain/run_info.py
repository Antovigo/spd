...
`pretrain.train` writes its weights to `<data_root>/pretrain_cache/<project>-<run_id>/`
...
def find_pretrain_cache(data_root: Path, project: str, run_id: str) -> PretrainCache:
