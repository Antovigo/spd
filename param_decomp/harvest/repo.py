...
class HarvestRepo:
    ...
    def __init__(
        self, decomposition_id: str, subrun_id: str, readonly: bool, data_root: Path
    ) -> None:
        self.subrun_id = subrun_id
        self._dir = get_harvest_subrun_dir(data_root, decomposition_id, subrun_id)
    ...
    def open_most_recent(
        ...
        decomposition_subruns_dir = get_harvest_dir(data_root, decomposition_id)
