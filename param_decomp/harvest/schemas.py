...
def get_harvest_dir(data_root: Path, decomposition_id: str) -> Path:
    """Base harvest dir for a decomposition."""
    return data_root / "runs" / decomposition_id / "harvest"


def get_harvest_subrun_dir(data_root: Path, decomposition_id: str, subrun_id: str) -> Path:
    """Subrun dir for a specific harvest invocation."""
    return get_harvest_dir(data_root, decomposition_id) / subrun_id
