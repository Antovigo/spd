...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    ...
    "resid_mlp1_global": ExperimentConfig(
        task_name="resid_mlp",
        decomp_script=Path("spd/experiments/resid_mlp/resid_mlp_decomposition.py"),
    ...
    "resid_mlp3_targeted": ExperimentConfig(
        task_name="resid_mlp",
        decomp_script=Path("spd/experiments/resid_mlp/resid_mlp_decomposition.py"),
        config_path=Path("spd/experiments/resid_mlp/resid_mlp3-targeted_config.yaml"),
        expected_runtime=30,
        canonical_run=None,
    ),
    ...
    "mem": ExperimentConfig(
        task_name="mem",
        decomp_script=Path("spd/experiments/mem/mem_decomposition.py"),
        config_path=Path("spd/experiments/mem/mem_config.yaml"),
        expected_runtime=15,
    ),
}
