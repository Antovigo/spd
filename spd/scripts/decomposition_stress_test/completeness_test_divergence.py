...
Usage:
    ...
    python -m spd.scripts.decomposition_stress_test.completeness_test_divergence <model_path> 3

    # Language model — input is a prompt string:
    python -m spd.scripts.decomposition_stress_test.completeness_test_divergence <model_path> "Once upon a time"
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SPD Completeness Test (Divergence)")
