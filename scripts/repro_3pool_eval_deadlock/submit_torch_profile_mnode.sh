...
export PD_TORCH_PROFILE_STACK=${PD_TORCH_PROFILE_STACK:-0}
export PD_TORCH_PROFILE_MODULES=${PD_TORCH_PROFILE_MODULES:-0}
export PD_TORCH_PROFILE_SHAPES=${PD_TORCH_PROFILE_SHAPES:-0}
